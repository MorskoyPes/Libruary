...
/* test.html.twig */
class __TwigTemplate_b510f4f41831a3d50b72a6a344a0c3508e7b0d9fa376f9edc0de32b497cc00ed extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 6
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 6, $this->source); })()), "autor", [], "any", false, false, false, 6), 'row');
        echo "
    <a href=\"/product\">
...
{% block body %}
    ...
    {{ form_end(form) }}
{% endblock %}", "test.html.twig", "C:\\composer\\liba\\templates\\test.html.twig");
    }
}
