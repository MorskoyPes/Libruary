...
/* show.html.twig */
class __TwigTemplate_925c53f530884ff6877142126f57b42bffe6eca6215ba11637284a8be73654fa extends Template
{
    private $source;
    private $macros = [];
...
\t\t<div> Year: ";
            // line 6
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["product"], "year", [], "any", false, false, false, 6), "html", null, true);
            echo "</div>
\t\t<div> Author: ";
            // line 7
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["product"], "author", [], "any", false, false, false, 7), "html", null, true);
            echo "</div>
\t    <a href=\"/product/edit/";
            // line 8
...
";
    ...
    {
        return array (  97 => 11,  88 => 8,  84 => 7,  80 => 6,  75 => 5,  71 => 4,  68 => 3,  58 => 2,  35 => 1,);
    }
...
{% endblock %}", "show.html.twig", "C:\\composer\\liba\\templates\\show.html.twig");
    }
}
