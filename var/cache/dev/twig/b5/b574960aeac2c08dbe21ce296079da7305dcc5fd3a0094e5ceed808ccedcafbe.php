...
/* form.html.twig */
class __TwigTemplate_c3d522de1815c3d6a95f596770d3563dff4f5f709daefefd23e2be8086aceb99 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 5
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 5, $this->source); })()), "year", [], "any", false, false, false, 5), 'row');
        echo "
    ";
        // line 6
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 6, $this->source); })()), "author", [], "any", false, false, false, 6), 'row');
        echo "
    </br>
    <input type = \"submit\" name = \"submit\" value = \"Save\"></br></br>
    <a href=\"/product\">-->Books list <--</a>
    ";
        // line 10
...
";
    ...
    {
        return array (  88 => 10,  81 => 6,  77 => 5,  73 => 4,  68 => 3,  58 => 2,  35 => 1,);
    }
...
{% block body %}
    ...
    <a href=\"/product\">-->Books list <--</a>
    {{ form_end(form) }}
{% endblock %}", "form.html.twig", "C:\\composer\\liba\\templates\\form.html.twig");
    }
}
